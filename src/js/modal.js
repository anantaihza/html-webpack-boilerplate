...
for (let index = 0; index < modalTriggers.length; index++) {
    ...
    e.addEventListener("click", function () {
       ...
       const modalOverlay = document.createElement("div"); 
        ...
        // ketika overlay (layar yang hitam transparan di click, wrapper langsung di hilangkan)    
       ...
       addClass(modalContent, "bg-white p-0 md:p-6 z-10 rounded-md");
